...
{{< figure src="/img/multibranching.png" alt="Typical merge related problem in multi-branching setup." align="center" width="700px" >}}
**Figure 1**: Typical merge related problem in a multi-branching setup.

{{< figure src="/img/singlebranching.png" alt="Single-branching way of managing merges." align="center" width="700px" >}}
**Figure 2**: Single-branching way of managing merges.
